public class Client_DLLString {
  public static void main(String[] args) {
    ...
    System.out.println("(Testing recursive toString) First list sorted is: [head] " + list_1.recursiveToString() + "[tail]");
    System.out.println("(Testing backwards) First list reversed (print) is: " + list_1.backwardsString());
    System.out.print("(Testing recursive backwards) First list reversed (print) is: [head] " + list_1.recursiveBackwardsString() + "[tail]");
    System.out.println();
